/*
 * Created by stevedamico on 9/25/17.
 */
package com.example.stevedamico.sdandroidwatchface;
...
import com.example.stevedamico.sdandroidwatchface.R;
    ...
    private class WatchFaceEngine extends Engine {
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            setWatchFaceStyle( new WatchFaceStyle.Builder( CustomWatchFaceService.this )
                    .setBackgroundVisibility( WatchFaceStyle.BACKGROUND_VISIBILITY_INTERRUPTIVE ).setCardPeekMode( WatchFaceStyle.PEEK_MODE_VARIABLE ).setShowSystemUiTime( false ).build());
            initBackground();
            initDisplayText();
